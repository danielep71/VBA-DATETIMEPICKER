...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Frm_DatePicker 
   ...
   ClientTop       =   465
   ClientWidth     =   5400
   OleObjectBlob   =   "Frm_DatePicker.frx":0000
...
'
'   This is UserForm code-behind. Paste it into Frm_DatePicker; do not import it
...
ErrorHandler:
    'Raise a descriptive error to the caller
        Err.Raise Err.Number, "Frm_DatePicker.UserForm_Initialize", Err.Description
...
ErrorHandler:
    'Raise a descriptive error to the caller
        Err.Raise Err.Number, "Frm_DatePicker.UserForm_Activate", Err.Description
...
'------------------------------------------------------------------------------
' PURPOSE
'   Applies the standard visual formatting to the existing Frm_DatePicker
'   UserForm instance
'
' WHY THIS EXISTS
